...
const RestaurantOwners = () => {
  ...
  const handleGetSubscriptions = async (ownerId) => {
    try {
      ...
      setDaysRemaining(Math.max(diffInDays, 0));
  ...
  async function handleActivate(days) {
    try {
      setLoading(true);
                  ...
                  <Box>
                      ...
                      gap={{xs: 2, md: 0}}>
                          ...
                          <Box display={'flex'} alignItems={'center'} gap={1}>
                              <Typography variant='h5' fontWeight={700} color={
                                finalProgress > 80 || isExpired ?  "#f44336" : 'primary.main'
                              }>
                                {console.log(daysRemaining)}
                                  {loading || daysRemaining == null ? <Skeleton variant='text' width={"100%"}/> : `${daysRemaining}`}
                              </Typography>
                              <Typography>
                      ...
                      sx={{ 
                          ...
                          '& .MuiLinearProgress-bar': {
                              backgroundColor: (finalProgress > 80 || isExpired) ? '#f44336' : 'primary.main', // Turns red if close to end
                          },
                          mt: 2
                      }} 
                      />
